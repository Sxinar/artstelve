...
// Search result link preference. false keeps visitors in the current tab.
export const searchResultsOpenNewTab = createPersistentStore('searchResultsOpenNewTab', false);
