...
export const selectedEngine = createPersistentStore('selectedEngine', 'Hybrid'); // Default Hybrid 

export const proxySearchEnabled = createPersistentStore('proxySearchEnabled', true);

export const proxyCustomUrl = createPersistentStore('proxyCustomUrl', '');

export const proxyResultCount = createPersistentStore('proxyResultCount', 20);
