    ...
    <div class="settings-content-wrapper">
        <main class="settings-main-content">
            <div style="margin-bottom: 1rem;">
                <a href="/search" class="button secondary" style="display: inline-flex; align-items: center; gap: 0.5rem; justify-content: center;">
                    <i class="fas fa-arrow-left"></i>
                    Aramaya dön
                </a>
            </div>

            <nav aria-label="Ayar sekmeleri" style="margin-bottom: 1.25rem;">
            ...
            {#if activeTab === "Temel Ayarlar"}
                <section in:slide={{ duration: 300 }}>
                        ...
                        <div class="setting-row">
                            ...
                            <div class="select-wrapper">
                                <select bind:value={$selectedEngine}>
                                    <option value="Hybrid">Hybrid (Proxy)</option>
                                </select>
                                <i class="fas fa-chevron-down dropdown-icon"
                                ></i>
                            </div>
                    ...
                    <div class="setting-card" style="margin-top: 2rem;">
                        <h3>Proxy Search Paneli</h3>
                        <p>Proxy arama ayarlarınızı buradan yönetebilirsiniz.</p>

                        <div class="setting-row" style="margin-top: 1rem;">
                            <div class="setting-info">
                                <h3>Proxy Arama</h3>
                                <p>Hibrit aramada proxy kaynaklarını kullanın.</p>
                            </div>
                            <label class="switch">
                                <input type="checkbox" bind:checked={$proxySearchEnabled} />
                                <span class="slider"></span>
                            </label>
                        </div>
                        ...
                        <div class="setting-row">
                            <div class="setting-info">
                                <h3>Sonuç Sayısı</h3>
                                <p>Web aramalarında hedeflenen sonuç sayısı.</p>
                            </div>
                            <div class="select-wrapper">
                                <input
                                    type="number"
                        ...
                        <div class="setting-row">
                            <div class="setting-info">
                                <h3>Custom Proxy URL</h3>
                                <p>Self-host proxy adresinizi girin (opsiyonel).</p>
                            </div>
                            <div class="select-wrapper">
                                <input
                                    type="text"
