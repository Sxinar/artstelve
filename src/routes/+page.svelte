  ...
  function setupSpeechRecognition() {
    ...
    instance.onerror = (event) => {
      ...
      if (event.error === 'no-speech' || event.error === 'audio-capture' || event.error === 'not-allowed') {
         ...
         alert(`Ses tanıma hatası: ${event.error === 'not-allowed' ? 'Mikrofon izni reddedildi.' : 'Ses algılanamadı veya mikrofon sorunu.'}`);
      } else {
...
<div class="home-container">
  ...
  <div class="search-container">
    <div class="search-box">
      ...
      />
      {#if searchQuery}
      <button class="clear-button" on:click={clearSearch} aria-label="Aramayı temizle">
      ...
      <button class="search-action-button" on:click={handleSearch} disabled={isLoading} aria-label="Ara">
        {#if isLoading}
